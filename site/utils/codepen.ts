const CSS_EXTERNAL = ['https://unpkg.com/arco-next@2.x/dist/arco.css'];
const JS_EXTERNAL = [
  'https://unpkg.com/vue@3.x/dist/vue.global.prod.js',
  'https://unpkg.com/dayjs@1.x/dayjs.min.js',
  'https://unpkg.com/arco-next@2.x/dist/arco-vue.min.js',
  'https://unpkg.com/arco-next@2.x/dist/arco-vue-icon.min.js',
];
...
const post = (data: any) => {
  ...
  field.name = 'data';
  field.type = 'hidden';
  field.setAttribute('value', JSON.stringify(data).replace(/"/g, '&quot;').replace(/'/g, '&apos;'));
